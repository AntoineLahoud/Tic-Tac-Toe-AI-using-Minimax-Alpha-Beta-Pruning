...
pg.display.set_caption("Tic Tac Toe Alpha Beta")
...
def alphabeta(state,depth,alpha,beta,player):
    ...
    if player==COMP:
        ...
        for cell in empty_cells(state):
            x,y=cell
            state[x][y]=player
            score=alphabeta(state,depth-1,alpha,beta,HUMAN)
            state[x][y]=0
            score[0],score[1]=x,y
        ...
        for cell in empty_cells(state):
            x,y=cell
            state[x][y]=player
            score=alphabeta(state,depth-1,alpha,beta,COMP)
            state[x][y]=0
            score[0],score[1]=x,y
...
def ai_move():
    ...
    move=alphabeta(state,depth,-infinity,infinity,COMP)
...
# user interaction part of the code
def user_click():
...
print("Welcome to Tic Tac Toe Alpha Beta 67")
